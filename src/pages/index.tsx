...
const Home: NextPage = () => {
  ...
  return (
    <>
      <SEO 
        title="BG3 Mods Navigation - Discover and Manage Your Baldur's Gate 3 Mods"
        description="Find, manage and enjoy the best Baldur's Gate 3 mods. Easy navigation, multilingual support, and comprehensive mod information."
      />
