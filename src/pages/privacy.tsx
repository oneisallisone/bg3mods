    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <article className="prose dark:prose-invert max-w-none">
        ...
        <ul>
          ...
          <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to bg3 mods.</li>
          ...
          <li><strong>Website</strong> refers to bg3 mods, accessible from <a href="https://bg3mods.com" rel="external nofollow noopener" target="_blank">https://bg3mods.com</a></li>
        ...
        <ul>
          <li>By email: dxpumpkin@gmail.com</li>
        </ul>
      </article>
    </div>
  );
